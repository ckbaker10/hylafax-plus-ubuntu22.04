...
#define FCF_PRIQ	0x08		// procedural interrupt modifier
...
#define	FCF_PSA		(0x06|FCF_SNDR)	   // polled subaddress (opt)
#define FCF_CIA		(0x07|FCF_SNDR)    // calling subscriber internet address (opt)
#define FCF_ISP		(0x08|FCF_SNDR)    // internet selective polling address (opt)
...
#define FCF_TSA		(0x40|0x06)	// transmitting subscriber internet address (opt)
...
#define FCF_CSA		0x24		// called subscriber internet address (opt)
