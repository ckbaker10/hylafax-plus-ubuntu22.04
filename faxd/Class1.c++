 ...
 */
bool
Class1Modem::recvFrame(HDLCFrame& frame, u_char dir, long ms, bool readPending, bool docrp, bool usehooksensitivity, u_int echofcf, bool docng, bool handlestutter)
{
    bool gotframe;
	...
	do {
	    ...
	    frame.reset();
            gotframe = recvRawFrame(frame);
	    if ((echofcf && gotframe && frame.getFCF() == echofcf) || (docrp && crpcnt && crpcnt < 3 && frame.getFCF() == FCF_CRP)) {
