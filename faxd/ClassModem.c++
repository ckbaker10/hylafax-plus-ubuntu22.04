...
CallType
ClassModem::answerCall(AnswerType atype, fxStr& emsg, const char* number, bool doSecondAnswer)
{
...
{
    long secs = datasize * 8 / ((br+1) * 2400) - discount + 15;
    dataTimeout = (secs > 15) ? secs*1000 : 15000;	// minimum 15-second dataTimeout here
}
