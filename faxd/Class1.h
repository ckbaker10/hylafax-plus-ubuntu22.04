...
protected:
    ...
    u_int	prevPPM;		// previous PPM during receive
...
// class 1 HDLC frame support
    ...
    bool	recvFrame(HDLCFrame& frame, u_char dir, long ms = 10*1000, bool readPending = false, bool docrp = true, bool usehooksensitivity = true, u_int echofcf = 0, bool docng = false, bool handlestutter = false);
