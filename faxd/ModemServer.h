...
// SSL Fax stuff
    int		sslFaxFd;		// listening socket
    bool	sslFaxConnection;	// whether or not we got an SSL Fax connection
// buffered i/o stuff
...
// modem driver interfaces
    ...
    CallType	modemAnswerCall(AnswerType, fxStr&, const char* dialnumber = NULL, bool doSecondAnswer = false);
...
inline int ModemServer::getSSLFaxFd()			{ return sslFaxFd; }
inline bool ModemServer::getSSLFaxConnection()		{ return sslFaxConnection; }
