...
// support to write to modem w/ timeout
    ...
    virtual int	getModemBit(long ms = 0);
    virtual int	getModemChar(long ms = 0, bool doquery = false);
    virtual int	getModemDataChar();
    int		getLastByte();
    bool	didBlockEnd();
    void	sawBlockEnd();
    void	resetBlock();
...
// server-related stuff
    ...
    virtual CallType answerCall(AnswerType, fxStr& emsg, const char* dialnumber = NULL, bool doSecondAnswer = false);
